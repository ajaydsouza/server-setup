...
1. [Protect an Nginx Server with Fail2Ban on Ubuntu 14.04](https://www.digitalocean.com/community/tutorials/how-to-protect-an-nginx-server-with-fail2ban-on-ubuntu-14-04)
2. [Set up Fail2Ban + WordPress + Nginx](https://konstantin.blog/2014/fail2ban-wordpress-nginx/)
3. [Integrate fail2ban with CloudFlare API v4 Guide](https://guides.wp-bullet.com/integrate-fail2ban-cloudflare-api-v4-guide/)
...
1. [How To Install and Configure Postfix on Ubuntu 18.04](https://www.digitalocean.com/community/tutorials/how-to-install-and-configure-postfix-on-ubuntu-18-04)
...
1. [Script to update UFW with Cloudflare IPs](https://github.com/Paul-Reed/cloudflare-ufw)
2. [Configuring the ufw firewall to allow Cloudflare IP addresses](https://designinterventionsystems.com/plone-blog/configuring-the-ufw-firewall-to-allow-cloudflare-ip-addresses)
3. [How do I restore original visitor IP with Nginx?](https://support.cloudflare.com/hc/en-us/articles/200170706-How-do-I-restore-original-visitor-IP-with-Nginx-)
4. [Getting Real IP Addresses Using CloudFlare, Nginx, and Varnish](https://danielmiessler.com/blog/getting-real-ip-addresses-using-cloudflare-nginx-and-varnish/)
